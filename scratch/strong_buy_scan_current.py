...
STAGE 2 - ENTRY / EXIT
  ...
  d. Entry: Buy-stop at the breakout candle's high, filled by a later candle.
  e. TP: Entry x 1.03 (+3.0%). Once TP is reached, no further trades that day.
  f. SL Criteria:
  ...
  g. Re-entry Criteria:
     ...
     - When another 5-min candle closes above this initial 15-min high with RSI(14) > 80
       before 1:00 PM, re-enter at that candle's high (buy-stop).
     - SL / TP rules for re-entered trades remain identical.
  h. End of day: All pending setups expire. Open trades square off at 15:15.
  a. Scan passes on a 5-min bar -> identify the 15-min candle that CONTAINS it
...
TP_PCT = 3.0
ENTRY_CUTOFF_TIME = dtime(13, 0)   # 1. post 1:00 PM we will not take any trade
