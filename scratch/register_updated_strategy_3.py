...
STRATEGY_NAME = "1-Hour Weekly R3 Trigger -> 5-Min Weekly R2 + RSI>85 Breakout (TP 3% | Dual VWAP & R2 SL)"
OLD_NAME = "15-Min Weekly R3 Trigger -> Weekly R2 + RSI>80 Breakout (TP 3% | VWAP SL)"
...
# Update old name if present, or add new name
updated_bt = False
for s in bt_strategies:
    if s.get('name') in (STRATEGY_NAME, OLD_NAME):
